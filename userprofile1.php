...
$abtmsg_fetchshow=fetchnamefromtable("17cs05_user_settings","UserID",$userid,"ShowOthers",$connection);
if($abtmsg_fetchshow==0){
$abtmsg_fetch="";
}
...
<h5 class="description-header"><?php echo $displayname_fetch; ?>&nbsp;&nbsp;&nbsp;&nbsp;</h5>

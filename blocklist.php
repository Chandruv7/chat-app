...
<table class="table " style="height: 10px;overflow-y:scroll;">
                  ...
                  <tbody >
                  	<?php 
                  	$frnd=0;
                  	$qry_friend = "SELECT * from 17cs05_friendrequest  where  CurrentlyActive='1' AND RequestStatus='5' AND (RequestTo='$userid' OR RequestFrom='$userid')";
...
$frnd++;
	...
	?>
                    <tr>
                      ...
                      <td>&nbsp;&nbsp;<span class="badge bg-success" style="cursor: pointer;" onclick="reqacpt('0','<?php echo $frnd_fetch; ?>');userupdate();"><i class="fa fa-unlock" style="color: #fff;"></i></span></td>
                ...
                <?php if($req_count==0){
  echo "<center><h4>No Users found <i class='fa fa-smile-o'></i></h4></center>";
...
$.ajax({
type:"POST",
url: "myfunctions/blocklists.php",
data:  {
reqname: reqval,
friendname: userval
},

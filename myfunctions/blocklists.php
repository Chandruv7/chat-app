...
$frnd++;
	...
	?>
                    <tr>
                      ...
                      <td>&nbsp;&nbsp;&nbsp;<span class="badge bg-success" style="cursor: pointer;" onclick="reqacpt('0','<?php echo $frnd_fetch; ?>');userupdate1();"><i class="fa fa-unlock" style="color: #fff;"></i></span></td>
                ...
                <?php if($req_count==0){
  echo "<center><h4>No Friends found <i class='fa fa-smile-o'></i></h4></center>";
